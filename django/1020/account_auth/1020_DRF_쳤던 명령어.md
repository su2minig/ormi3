...
# 회원가입은 어카운트에 있어야하지만 코드 복잡도를 위해 이번만 블로그에 작성

###################################

1020 > FE > register.html 폴더생성
...
<body>
    <form action="http://127.0.0.1:8000/blog/register/" method="post">
        ...
        패스워드: <input type="text" id="password" name="password"><br>
        패스워드2: <input type="text" id="password2" name="password2"><br>
